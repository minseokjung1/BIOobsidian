---
{"dg-publish":true,"title":"1. Pharmacokinetics Overview","permalink":"///1-pharmacokinetics-overview/","dgPassFrontmatter":true}
---
...
Pharmacokinetics는 ADME 4단계로 이루어짐
 ...
 - ==[[블로그 업로드/단어/First Pass Effect\|First Pass Effect]]==
	...
	- 정맥 주사([[블로그 업로드/단어/I.V.\|I.V.]] injection)는 ==[[블로그 업로드/단어/First Pass Effect\|First Pass Effect]]를 우회==하므로, 약물이 Liver에서 대사되기 전에 바로 Systemic Circulation에 도달함
